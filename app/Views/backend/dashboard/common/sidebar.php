<nav class="navbar-default navbar-static-side" role="navigation">
    ...
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <li class="<?php echo ( $uriModule == 'audit_log') ? 'active'  : '' ?>">
                <a href="index.html"><i class="fa fa-users" aria-hidden="true"></i> <span class="nav-label">QL Nhật ký hoạt động</span> <span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                        <li class="<?php echo ( $uriModule_name == 'audit_logs') ? 'active'  : '' ?>">
                        <a href="<?php echo base_url('backend/log/log/index') ?>">Nhật Ký hoạt động</a>
                    </li>
                </ul>
            </li>
