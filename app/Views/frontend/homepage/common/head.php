...
<script src="<?php echo ASSET_FRONTEND . 'plugins/OwlCarousel2-2.3.4/dist/owl.carousel.min.js'; ?>"></script>
<script src="<?php echo ASSET_FRONTEND . 'js/jquery-3.1.1.min.js'; ?>"></script>