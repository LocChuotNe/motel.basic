...
define('SYSTEM_NAME', 'CVG');
define('AUTH', 'HTVIETNAM_');
define('ASSET_BACKEND', 'backend/');
define('ASSET_FRONTEND', 'frontend/');

define('BASE_URL', 'http://motel.chuotne/');
define('HTSUFFIX', '');

define('DEBUG', 0);
define('COMPRESS', 0);
define('CMS_NAME', 'CVG CMS 3.0');
