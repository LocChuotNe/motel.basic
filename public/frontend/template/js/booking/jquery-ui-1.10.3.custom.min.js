...
(function (e, t) {
    function i(t, i) {
        ...
        return "area" === o
            ? ((s = t.parentNode), (n = s.name), t.href && n && "map" === s.nodeName.toLowerCase() ? ((r = e("img[usemap=#" + n + "]")[0]), !!r && a(r)) : !1)
            : (/input|select|textarea|button|object/.test(o) ? !t.disabled : "a" === o ? t.href || i : i) && a(t);
    }
    function a(t) {
        return (
...
(function (e, t) {
    ...
    e.extend(i.prototype, {
        ...
        _generateHTML: function (e) {
            ...
            for (
                e.drawMonth = Z,
                    ...
                    i = Q ? this.formatDate(i, this._daylightSavingAdjust(new Date(et, Z - V, 1)), this._getFormatConfig(e)) : i,
                    ...
                    s = Q ? this.formatDate(s, this._daylightSavingAdjust(new Date(et, Z + V, 1)), this._getFormatConfig(e)) : s,
                    n = this._canAdjustMonth(e, 1, et, Z)
                        ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (Y ? "w" : "e") + "'>" + s + "</span></a>"
                        : $
                        ? ""
                        : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (Y ? "w" : "e") + "'>" + s + "</span></a>",
                ...
                for (D = "", this.maxRows = 4, w = 0; B[1] > w; w++) {
                    ...
                    for (
                        S +=
                            ...
                            this._generateMonthYearHeader(e, Z, et, q, X, x > 0 || w > 0, m, f) +
                        ...
                        for (S += "<tr>", E = d ? "<td class='ui-datepicker-week-col'>" + this._get(e, "calculateWeek")(j) + "</td>" : "", k = 0; 7 > k; k++)
                            (z = g ? g.apply(e.input ? e.input[0] : null, [j]) : [!0, ""]),
                                ...
                                (E +=
                                    ...
                                    ((j.getTime() === T.getTime() && Z === e.selectedMonth && e._keyEvent) || (b.getTime() === j.getTime() && b.getTime() === T.getTime()) ? " " + this._dayOverClass : "") +
                                    (O ? " " + this._unselectableClass + " ui-state-disabled" : "") +
                                    (L && !v ? "" : " " + z[1] + (j.getTime() === G.getTime() ? " " + this._currentClass : "") + (j.getTime() === W.getTime() ? " ui-datepicker-today" : "")) +
                                    "'" +
                                    ((L && !v) || !z[2] ? "" : " title='" + z[2].replace(/'/g, "&#39;") + "'") +
                                    (O ? "" : " data-handler='selectDay' data-event='click' data-month='" + j.getMonth() + "' data-year='" + j.getFullYear() + "'") +
                                    ">" +
                                    (L && !v
                                        ? "&#xa0;"
                                        : O
                                        ...
                                        : "<a class='ui-state-default" +
                                          (j.getTime() === W.getTime() ? " ui-state-highlight" : "") +
        ...
        _isInRange: function (e, t) {
            ...
            return (
                h && ((i = h.split(":")), (a = new Date().getFullYear()), (r = parseInt(i[0], 10)), (o = parseInt(i[1], 10)), i[0].match(/[+\-].*/) && (r += a), i[1].match(/[+\-].*/) && (o += a)),
